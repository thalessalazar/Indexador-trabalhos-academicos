...
public class AlterarTCC extends javax.swing.JFrame {
    
    public Integer id_tcc;
    public String dest;
    ...
    public AlterarTCC(Integer id_tcc) {
        this.id_tcc = id_tcc;
        initComponents();
        setIcon();
        populaCampos(id_tcc);
    ...
    public void populaCampos(Integer id_tcc) {
        TccDAO tccdao = new TccDAO();
        Tcc tcc = tccdao.buscarPorChavePrimaria(id_tcc);
        tfAno.setText(tcc.getAnoTcc().toString());
        tfAutor.setText(tcc.getAutorTcc());
        tfOrientador.setText(tcc.getOrientadorTcc());
        tfTitulo.setText(tcc.getTituloTcc());
        cbxSem.setSelectedIndex(tcc.getSemestreTcc());
        cbxTipo.setSelectedIndex(tcc.getIdAreatcc().getIdAreatcc());
        txtAOb.setText(tcc.getObservacoesTcc());
    }
    ...
    public void PDF() {
        ...
        try {
            ...
            Logger.getLogger(AlterarTCC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1960, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarTCC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarTCC().setVisible(true);
            }
        });
    }
